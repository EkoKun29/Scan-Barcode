                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <img src="../../assets/img/msg.svg" alt="MSG" width="100%" height="auto"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Selamat Datang Di Website Management Stock Gudang!</h1>
                                    </div>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="{{ route('_register') }}">Buat Akun!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
